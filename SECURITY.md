...
mapsnap, please email [Ygor](mailto:ygbr@mac.com)
and [Danilo](mailto:mawkee@gmail.com) directly.
...
This following information discusses the process the mapsnap project
...
versions of mapsnap if upgrading is not an option.
